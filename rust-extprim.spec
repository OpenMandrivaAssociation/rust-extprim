...
BuildRequires:  (crate(semver/default) >= 0.9.0 with crate(semver/default) < 0.10.0)
BuildRequires:  (crate(serde/default) >= 1.0.0 with crate(serde/default) < 2.0.0)
BuildRequires:  (crate(serde/derive) >= 1.0.0 with crate(serde/derive) < 2.0.0)
%if %{with check}
BuildRequires:  (crate(extprim_literals/default) >= 2.0.0 with crate(extprim_literals/default) < 3.0.0)
%endif
